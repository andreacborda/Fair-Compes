...
function detectPatterns(data,country,t){
  ...
  let level,color;
  if(score>=55){level="CRÍTICO";color=C.red;}else if(score>=35){level="ALTO";color=C.amber;}else if(score>=15){level="MEDIO";color="#d97706";}else{level="BAJO";color=C.green;}
